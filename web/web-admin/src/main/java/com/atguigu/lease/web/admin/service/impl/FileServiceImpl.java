...
public class FileServiceImpl implements FileService {
    ...
    public String upload(MultipartFile file) {
        ...
        try {
            ...
            String filename = new StringBuilder().append(new SimpleDateFormat("yyyyMMdd").format(new Date())).append("/").append(UUID.randomUUID()).append("-").append(file.getOriginalFilename()).toString();
